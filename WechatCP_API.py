...
import json
import requests
from conf_example import CORPID, CORPSECRET,CORPSECRET2,agentid,department_id
...
class WeChatEnterprise():
    ...
    def __init__(self, agentid=agentid,corpsecret =CORPSECRET ):
        """
    ...
    def __post(self, url, data):
        res = requests.post(url, data=json.dumps(data).encode('utf-8').decode('utf-8', 'ignore')).json()
